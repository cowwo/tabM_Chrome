export const messages = {
  "zh-CN": {
    ...
    "sidepanel.reconnecting.title": "正在重新连接后台",
    "sidepanel.reconnecting.body": "后台连接暂时断开，插件正在自动重连，恢复后可以继续使用。",
    ...
    "sidepanel.toolbar.selection.cancel": "取消多选",
  ...
  en: {
    ...
    "sidepanel.reconnecting.title": "Reconnecting to background",
    "sidepanel.reconnecting.body": "The background connection was lost. The extension is reconnecting automatically and will resume once recovered.",
    ...
    "sidepanel.toolbar.selection.cancel": "Cancel multi-select",
